...
class ViewController: UIViewController, UISearchResultsUpdating, UITableViewDelegate, UITableViewDataSource, UISearchControllerDelegate {
    ...
    lazy var precipitationMapContainer: UIView = {
            ...
            container.addSubview(precipitationMapView)
            container.addSubview(mapLabel)

            NSLayoutConstraint.activate([
                mapLabel.topAnchor.constraint(equalTo: container.topAnchor, constant: 10),
                mapLabel.leadingAnchor.constraint(equalTo: container.leadingAnchor, constant: 10),
                
                precipitationMapView.topAnchor.constraint(equalTo: mapLabel.bottomAnchor, constant: 10),
                precipitationMapView.leadingAnchor.constraint(equalTo: container.leadingAnchor, constant: 10),
                precipitationMapView.trailingAnchor.constraint(equalTo: container.trailingAnchor, constant: -10),
                precipitationMapView.bottomAnchor.constraint(equalTo: container.bottomAnchor, constant: -10),
            ])
